...
namespace Avant.Repository.Helpers
{
    public class RepositoryFactories
    {
        ...
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM RENT A CAR PLUS FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetCodeCamperFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(ICouponRepository), dbContext => new CouponRepository(dbContext)},
                   {typeof(ICustomerCouponRepository), dbContext => new CustomerCouponRepository(dbContext)},
